...
class FinetuneOptions():
    def __init__(self):
        ...
        self.parser.add_argument('--outer_iter', type=int, default=20,
                                 help='number of iteration for fading in progressive training')
        self.parser.add_argument(
            '--epoch', type=int, default=1, help='number of epoch for each outer iteration')
        self.parser.add_argument(
            '--batchsize', type=int, default=8, help='batchsize')
        self.parser.add_argument(
            '--datasize', type=int, default=80, help='number of sampled data for each epoch')
        self.parser.add_argument('--supervise', type=int, default=1,
                                 help='1 for supervised learning, 0 for unsupervised learning')
